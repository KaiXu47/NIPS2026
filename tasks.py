...
tasks['ade'] = {
    ...
    "100-10":
        {
            0: list(range(100)), # Original ADE 1-100 -> Model 0-99
            1: list(range(100, 110)), # Original ADE 101-110 -> Model 100-109
            2: list(range(110, 120)),
            3: list(range(120, 130)),
            4: list(range(130, 140)),
            5: list(range(140, 150)),
        }
}
